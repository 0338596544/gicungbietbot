...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6069207221:AAFRSbpHf1uK1WH3pQ4SFGaHTzF_TugCOL0"
else:
    tgkey = tgenv
print(tgenv)
...
botname = 'Cuong'
username = 'gcbgpt_bot'
# Max chat log lengtA token is about 4 letters and max tokens is 2048)
max = int(3000)
